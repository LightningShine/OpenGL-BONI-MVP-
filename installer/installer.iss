...
; Repo-relative: Inno resolves these against the folder of this .iss.
; Absolute paths to one developer machine are gone on purpose.
#define RepoRoot   ".."
#define ReleaseDir RepoRoot + "\x64\Release"
#define AssetsDir  RepoRoot + "\OpenGL\assets"
...
#define TracksDir  RepoRoot + "\OpenGL\saves\tracks"
; Драйвер USB-моста CP210x (Silicon Labs). Файлы туда кладут руками, в git их
; нет — см. installer\redist\CP210x\README.txt.
#define DriverDir  "redist\CP210x"
...
; Содержимое папки задаётся вручную, см. installer\redist\CP210x\README.txt: либо
